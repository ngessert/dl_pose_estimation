...
mdlParams['saveDir'] = '/path/to/savedir/resnext'
# Data is loaded from here
mdlParams['dataDir'] = '/path/to/data/'

### Model Selection ###
mdlParams['model_type'] = 'ResNeXt3D'
mdlParams['batch_func_type'] = 'getBatch3D'

### ResNeXt3D Parameters ###
# Defines number of modules and blocks per module
mdlParams['ResNeXt3D_Size'] = [4,5]
# Defines the stride that is used at the beginning of each module
mdlParams['ResNeXt3D_Stride'] = [2,2]
# Defines the base number of feature maps
mdlParams['ResNeXt3D_FM'] = 64
# Defines the base number of feature maps for the bottleneck
mdlParams['ResNeXt3D_Red_FM'] = 12
# Cardinality, see paper for details
mdlParams['cardinality'] = 16
